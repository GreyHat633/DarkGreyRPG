...
public sealed class DialogueDocument : INotifyPropertyChanged
{
    ...
    public static DialogueDocument CreateNew(string id, string title = "新对话") => new(new DialogueResource { Id = id, Title = title, DisplayName = title, HomeStoryId = "uncategorized", Entry = string.Empty, Nodes = [] }, null, true);
